    ...
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={` fixed left-0 top-0 flex h-screen w-72.5 flex-col 
          bg-slate-800 z-50 lg:translate-x-0 
          duration-300 ease-linear
          ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}
          `}
      >
        {/* <!-- SIDEBAR HEADER --> */}
        <div className="flex items-center justify-between gap-2 px-6  py-3 lg:py-4 text-gray-100">
          <div className="flex items-center bg-gray-300 rounded-md hover:bg-gray-100 px-3">
            <Logo />
          </div>
          <button
        ...
        <div className="sidebar-content overflow-y-auto flex flex-col duration-300 ease-linear">
          {/* <!-- Sidebar Menu --> */}
          <nav className="mt-2 px-4 py-4 lg:mt-1 lg:px-6">
