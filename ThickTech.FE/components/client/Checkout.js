...
//   // Sử dụng CartContext để lấy danh sách sản phẩm và hàm liên quan
...
//               <div className="flex gap-3 items-center" key={item.productId}>
//                 <img
...
//                     đ {item?.product?.salling_price * item?.quantity}
//                   </h3>
//                 </div>
//               </div>
//             ))}
