...
import SidePageAuth from "@/components/auth/SidePageAuth";
...
const SignUpForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validatePassword(password)) {
      setErrorMessage(
        "Password must be at least 8 characters long, include a number, a special character, a lowercase and an uppercase letter!"
      );
      return;
    }

    try {
      // Replace with your API call for signup
  ...
  return (
    <div className="container mx-auto px-4 py-5 bg-white mb-20">
      <div className="flex flex-wrap items-center">
        <SidePageAuth />
        <div className="w-full xl:w-1/2 border rounded-lg shadow-lg shadow-slate-700">
          <div className="w-full p-4 sm:p-12 xl:p-10">
            <h2 className="text-2xl font-bold text-slate-800 sm:text-title-xl2 text-center">
              Tạo tài khoản ThickTech
            </h2>
            <form>
              <div className="mb-4">
